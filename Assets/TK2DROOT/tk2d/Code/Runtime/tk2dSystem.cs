...
public class tk2dSystem : ScriptableObject
{
    ...
    public const bool useZSpriteManager = true;
	...
	public static tk2dSystem inst
	{
		get 
		{
			if (_inst == null)
			{
				...
				_inst = ZResourceManager.Instance.Load(assetName, typeof(tk2dSystem)) as tk2dSystem;
				if (_inst == null)
				{
...
#region Resources
	...
	{
		tk2dResource resource = ZResourceManager.Instance.Load(guidPrefix + guid, typeof(tk2dResource)) as tk2dResource;
		if (resource != null)
